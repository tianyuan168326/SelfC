...
class LQGTVID_AugDataset(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        super(LQGTVID_AugDataset, self).__init__()
        self.opt = opt
    ...
    def gen_aug_params(self):
        ...
        self.elastic_deform = self.opt['use_elastic_deform'] and random.random() < 0.5
        self.need_aug = True
    ...
    def read_img(self,GT_path,scale,GT_size):
        ...
        if self.opt['phase'] == 'train':
            ...
            if self.elastic_deform:
                img_GT = elasticdeform.deform_random_grid(img_GT, axis=(0, 1), sigma=12, points=3)
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'test':
            ...
            index2 = random.randint(index1+1,3)
            index3 = random.randint(index2+1,4)
            index4 = random.randint(index3+1,5)
            index5 = random.randint(index4+1,6)
