...
class LQGTVIDDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if not GlobalVar.get_Temporal_LEN():
    ...
    def read_img(self,GT_path,scale,GT_size):
        ...
        if self.opt['phase'] == 'train':
            ...
            img_GT,img_LQ = util.augment([ img_GT,img_LQ], 
            self.hflip,
            self.vflip,
            self.rot90
            )
    ...
    def __getitem__(self, index):
        ...
        vid_HQ = vid_HQ.permute(3,1,0,2)
        vid_LQ = vid_LQ.permute(3,1,0,2)
        ...
        return { 'GT': vid_HQ,'LQ': vid_LQ, 'LQ_path': GT_path[0], 'GT_path': GT_path[0]}
